...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PublishState<T>);
}
...
/// @nodoc
class $PublishStateCopyWith<T,$Res>  {
$PublishStateCopyWith(PublishState<T> _, $Res Function(PublishState<T>) __);
}


/// Adds pattern-matching-related methods to [PublishState].
extension PublishStatePatterns<T> on PublishState<T> {
...
class Initial<T> implements PublishState<T> {
  const Initial();
...
class Loading<T> implements PublishState<T> {
  const Loading();
...
class Success<T> implements PublishState<T> {
...
@override
String toString() {
  return 'PublishState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $PublishStateCopyWith<T, $Res> {
...
class Error<T> implements PublishState<T> {
...
@override
String toString() {
  return 'PublishState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $PublishStateCopyWith<T, $Res> {
