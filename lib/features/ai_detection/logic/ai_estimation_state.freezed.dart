...
part of 'ai_estimation_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AiEstimationState<T>);
}
...
/// @nodoc
class $AiEstimationStateCopyWith<T,$Res>  {
$AiEstimationStateCopyWith(AiEstimationState<T> _, $Res Function(AiEstimationState<T>) __);
}


/// Adds pattern-matching-related methods to [AiEstimationState].
extension AiEstimationStatePatterns<T> on AiEstimationState<T> {
...
class Initial<T> implements AiEstimationState<T> {
  const Initial();
...
@override
String toString() {
  return 'AiEstimationState<$T>.initial()';
}
...
class Loading<T> implements AiEstimationState<T> {
  const Loading();
...
@override
String toString() {
  return 'AiEstimationState<$T>.loading()';
}
...
class Success<T> implements AiEstimationState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of AiEstimationState
...
@override
String toString() {
  return 'AiEstimationState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AiEstimationStateCopyWith<T, $Res> {
...
class Error<T> implements AiEstimationState<T> {
...
@override
String toString() {
  return 'AiEstimationState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $AiEstimationStateCopyWith<T, $Res> {
